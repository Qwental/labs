...
int main()
{
    ...
    puts("Ввели в 10СС числа Капрекара и Ожидаем их полный вывод  1, 9, 45, 55, 99, 297, 703, 999, 2223, 2728, 4879, 4950, 5050, 7272, 7777, 9999, 17344, 994708");
    ...
    puts("Ожидаем: 45, 55, 1");

    puts("Ввели в 12СС:  1, 9, 56, 66");
    base = 12;
    puts("Ожидаем: 1, 56, 66");

    print_point3(4, result3, base, "1", "9", "56", "66");

    puts("Ввели в 16СС:  1, 6, A, F, 5B, 78, D5D5");
    puts("Ожидаем: 1, 6, A, F, 55, 5B, 78, D5D5");

    base = 16;
    print_point3(8, result3, base, "1", "6", "A", "F", "55", "5B", "78", "D5D5");

    puts("Ввели в 16СС: 10, -12, 2D02E, 345353");
    puts("Ожидаем: 2D02E");

    print_point3(4, result3, base, "10", "-12", "2D02E", "345353");
